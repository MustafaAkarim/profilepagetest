        ...
        {EXPERIENCES.map((experience, index) => (
          <div key={index} className="mb-8 flex flex-wrap lg:justify-center">
            <motion.div
              ...
              initial={{ opacity: 0, x: -100 }} // Initial state for year animation
            ...
            <motion.div
              whileInView={{ opacity: 1, x: 0 }} // Final state when in view
              initial={{ opacity: 0, x: 100 }} // Initial state for job details animation (from right)
              transition={{ duration: 1 }} // Duration for the transition
            ...
            >
              ...
              {experience.technologies.map((tech, index) => (
                <span
                  key={index}
                  className="my-2 mt-4 rounded bg-neutral-900 px-2 py-1 text-small font-medium text-purple-800"
                >
                  {tech}
                </span>
              ))}
